...
module.exports = {
  up: async (queryInterface, Sequelize) => {
     await queryInterface.createTable('usuarios', { 
        ...
        is_administrador: { type: Sequelize.DataTypes.BOOLEAN, allowNull: false, default: false },
        is_usuario: { type: Sequelize.DataTypes.BOOLEAN, allowNull: false, default: false },
        ativo: { type: Sequelize.DataTypes.BOOLEAN, allowNull: false, default: false },
